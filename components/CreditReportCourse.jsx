    ...
    <main className="reader-main">
      ...
      <div className="reader-body">
        ...
        <section className="reader-section" id="action">
          ...
          <details className="thinking-guide"><summary>Check Your Thinking <ChevronDown /></summary><div><p><b>11.</b> A good answer identifies a field such as name, address, date of birth or employer information and distinguishes familiar historical information from something truly unfamiliar.</p><p><b>12.</b> The key is to record the balance together with the reporting date and account status. A balance without its date can be misleading.</p><p><b>13.</b> A useful translation names the account, when it was opened if shown, the reported balance/limit or loan information, the update date and current status in ordinary language.</p><p><b>14.</b> If an application-related inquiry is unfamiliar, verify it. Do not assume every inquiry on a consumer disclosure represents a new credit application.</p><p><b>15.</b> Green = recognized/appears accurate. Yellow = needs context or evidence. Red = not yours, clearly appears false or may signal fraud; investigate promptly.</p></div></details>
        </section>
