...
export function AdminDashboard({ course }) {
  ...
  useEffect(()=>{
    requestAnimationFrame(()=>{try{setSubmissions(JSON.parse(localStorage.getItem("cp-course-1-submissions"))||[])}catch{}});
  },[]);
