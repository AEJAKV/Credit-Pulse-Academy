...
const publishedPlatinumMoneyRoutes = ["/course/platinum/understanding-a-canadian-paycheque", "/course/platinum/marginal-tax-rates", "/course/platinum/filing-an-income-tax-return", "/course/platinum/common-tax-deductions-and-credits", "/course/platinum/tfsa-basics", "/course/platinum/rrsp-basics", "/course/platinum/fhsa-basics", "/course/platinum/resp-basics", "/course/platinum/rdsp-basics", "/course/platinum/rrif-basics", "/course/platinum/tax-free-versus-tax-deferred-growth", "/course/platinum/investment-fees", "/course/platinum/etfs-and-mutual-funds", "/course/platinum/risk-tolerance", "/course/platinum/compound-growth"];
const publishedDiamondRoutes = ["/course/diamond/canadian-retirement-planning", "/course/diamond/estate-and-beneficiary-basics", "/course/diamond/self-employment-taxes", "/course/diamond/gst-hst-for-small-businesses", "/course/diamond/keeping-cra-records"];
const publishedDiamondFitnessRoutes = ["/course/diamond/beginner-fitness-for-men", "/course/diamond/beginner-fitness-for-women", "/course/diamond/home-workouts", "/course/diamond/gym-fundamentals", "/course/diamond/strength-training", "/course/diamond/muscle-building", "/course/diamond/fat-loss-fundamentals", "/course/diamond/low-impact-fitness", "/course/diamond/fitness-over-40", "/course/diamond/fitness-over-50", "/course/diamond/mobility", "/course/diamond/flexibility", "/course/diamond/core-strength", "/course/diamond/resistance-band-training", "/course/diamond/bodyweight-training"];
...
function PlatinumCatalog() {
  return <div className="tier-content"><div className="tier-inheritance"><p className="tier-includes">Includes all Starter Courses</p><p className="tier-includes">Includes all Silver Courses</p><p className="tier-includes">Includes all Gold Courses</p></div>{platinumCourses.map((course,courseIndex)=><details className="catalog-course" open={courseIndex===0} key={course.title}><summary><span>{`COURSE ${courseIndex+1}`}</span><div><strong>{course.title}</strong><small>{course.modules.length} modules · {courseIndex===0?"10 published":courseIndex===1?"15 published":`${course.modules.length} planned`}</small></div><i aria-hidden="true">+</i></summary><ol className="module-list">{course.modules.map((title,moduleIndex)=>{const published=(courseIndex===0&&moduleIndex<10)||(courseIndex===1&&moduleIndex<15);return <li className={published?"published":""} key={title}><span>{`${courseIndex+1}.${moduleIndex+1}`}</span><div><strong>{title}</strong><small>{published?"Published":"Planned"}</small></div>{published&&<a href={(courseIndex===0?publishedPlatinumRoutes:publishedPlatinumMoneyRoutes)[moduleIndex]} target="_blank" rel="noreferrer" aria-label={`Open ${title} learner view`}>Open ↗</a>}</li>})}</ol></details>)}</div>;
}

function DiamondCatalog() {
  return <div className="tier-content"><div className="tier-inheritance"><p className="tier-includes">Includes all Starter Courses</p><p className="tier-includes">Includes all Silver Courses</p><p className="tier-includes">Includes all Gold Courses</p><p className="tier-includes">Includes all Platinum Courses</p></div>{diamondCourses.map((course,courseIndex)=><details className="catalog-course" open={courseIndex===0} key={course.title}><summary><span>{`COURSE ${courseIndex+1}`}</span><div><strong>{course.title}</strong><small>{course.modules.length} modules · {courseIndex===0?"5 published":courseIndex===1?"15 published":`${course.modules.length} planned`}</small></div><i aria-hidden="true">+</i></summary><ol className="module-list">{course.modules.map((title,moduleIndex)=>{const published=(courseIndex===0&&moduleIndex<5)||(courseIndex===1&&moduleIndex<15);return <li className={published?"published":""} key={title}><span>{`${courseIndex+1}.${moduleIndex+1}`}</span><div><strong>{title}</strong><small>{published?"Published":"Planned"}</small></div>{published&&<a href={(courseIndex===0?publishedDiamondRoutes:publishedDiamondFitnessRoutes)[moduleIndex]} target="_blank" rel="noreferrer" aria-label={`Open ${title} learner view`}>Open ↗</a>}</li>})}</ol></details>)}</div>;
}
...
export function AdminDashboard() {
  ...
  useEffect(()=>{
    requestAnimationFrame(()=>{try{const gold13=JSON.parse(localStorage.getItem("cp-gold-1-3-submissions"))||[];const gold14=JSON.parse(localStorage.getItem("cp-gold-1-4-submissions"))||[];const gold15=JSON.parse(localStorage.getItem("cp-gold-1-5-submissions"))||[];const gold16=JSON.parse(localStorage.getItem("cp-gold-1-6-submissions"))||[];const gold17=JSON.parse(localStorage.getItem("cp-gold-1-7-submissions"))||[];const gold18=JSON.parse(localStorage.getItem("cp-gold-1-8-submissions"))||[];const gold19=JSON.parse(localStorage.getItem("cp-gold-1-9-submissions"))||[];const gold110=JSON.parse(localStorage.getItem("cp-gold-1-10-submissions"))||[];const gold111=JSON.parse(localStorage.getItem("cp-gold-1-11-submissions"))||[];const gold112=JSON.parse(localStorage.getItem("cp-gold-1-12-submissions"))||[];const gold113=JSON.parse(localStorage.getItem("cp-gold-1-13-submissions"))||[];const gold114=JSON.parse(localStorage.getItem("cp-gold-1-14-submissions"))||[];const gold115=JSON.parse(localStorage.getItem("cp-gold-1-15-submissions"))||[];const gold116=JSON.parse(localStorage.getItem("cp-gold-1-16-submissions"))||[];const gold117=JSON.parse(localStorage.getItem("cp-gold-1-17-submissions"))||[];const gold118=JSON.parse(localStorage.getItem("cp-gold-1-18-submissions"))||[];const gold119=JSON.parse(localStorage.getItem("cp-gold-1-19-submissions"))||[];const gold120=JSON.parse(localStorage.getItem("cp-gold-1-20-submissions"))||[];const gold21=JSON.parse(localStorage.getItem("cp-gold-2-1-submissions"))||[];const gold22=JSON.parse(localStorage.getItem("cp-gold-2-2-submissions"))||[];const gold23=JSON.parse(localStorage.getItem("cp-gold-2-3-submissions"))||[];const gold24=JSON.parse(localStorage.getItem("cp-gold-2-4-submissions"))||[];const gold25=JSON.parse(localStorage.getItem("cp-gold-2-5-submissions"))||[];const platinum12=JSON.parse(localStorage.getItem("cp-platinum-1-2-submissions"))||[];const platinum13=JSON.parse(localStorage.getItem("cp-platinum-1-3-submissions"))||[];const platinum14=JSON.parse(localStorage.getItem("cp-platinum-1-4-submissions"))||[];const platinum15=JSON.parse(localStorage.getItem("cp-platinum-1-5-submissions"))||[];const platinum16=JSON.parse(localStorage.getItem("cp-platinum-1-6-submissions"))||[];const platinum17=JSON.parse(localStorage.getItem("cp-platinum-1-7-submissions"))||[];const platinum18=JSON.parse(localStorage.getItem("cp-platinum-1-8-submissions"))||[];const platinum19=JSON.parse(localStorage.getItem("cp-platinum-1-9-submissions"))||[];const platinum110=JSON.parse(localStorage.getItem("cp-platinum-1-10-submissions"))||[];const platinum221=JSON.parse(localStorage.getItem("cp-platinum-2-1-submissions"))||[];const platinum222=JSON.parse(localStorage.getItem("cp-platinum-2-2-submissions"))||[];const platinum223=JSON.parse(localStorage.getItem("cp-platinum-2-3-submissions"))||[];const platinum224=JSON.parse(localStorage.getItem("cp-platinum-2-4-submissions"))||[];const platinum225=JSON.parse(localStorage.getItem("cp-platinum-2-5-submissions"))||[];const platinum226=JSON.parse(localStorage.getItem("cp-platinum-2-6-submissions"))||[];const platinum227=JSON.parse(localStorage.getItem("cp-platinum-2-7-submissions"))||[];const platinum228=JSON.parse(localStorage.getItem("cp-platinum-2-8-submissions"))||[];const platinum229=JSON.parse(localStorage.getItem("cp-platinum-2-9-submissions"))||[];const platinum2210=JSON.parse(localStorage.getItem("cp-platinum-2-10-submissions"))||[];const platinum2211=JSON.parse(localStorage.getItem("cp-platinum-2-11-submissions"))||[];const platinum2212=JSON.parse(localStorage.getItem("cp-platinum-2-12-submissions"))||[];const platinum2213=JSON.parse(localStorage.getItem("cp-platinum-2-13-submissions"))||[];const platinum2214=JSON.parse(localStorage.getItem("cp-platinum-2-14-submissions"))||[];const platinum2215=JSON.parse(localStorage.getItem("cp-platinum-2-15-submissions"))||[];const diamond11=JSON.parse(localStorage.getItem("cp-diamond-1-1-submissions"))||[];const diamond12=JSON.parse(localStorage.getItem("cp-diamond-1-2-submissions"))||[];const diamond13=JSON.parse(localStorage.getItem("cp-diamond-1-3-submissions"))||[];const diamond14=JSON.parse(localStorage.getItem("cp-diamond-1-4-submissions"))||[];const diamond15=JSON.parse(localStorage.getItem("cp-diamond-1-5-submissions"))||[];const diamond21=JSON.parse(localStorage.getItem("cp-diamond-2-1-submissions"))||[];const diamond22=JSON.parse(localStorage.getItem("cp-diamond-2-2-submissions"))||[];const diamond23=JSON.parse(localStorage.getItem("cp-diamond-2-3-submissions"))||[];const diamond24=JSON.parse(localStorage.getItem("cp-diamond-2-4-submissions"))||[];const diamond25=JSON.parse(localStorage.getItem("cp-diamond-2-5-submissions"))||[];const diamond26=JSON.parse(localStorage.getItem("cp-diamond-2-6-submissions"))||[];const diamond27=JSON.parse(localStorage.getItem("cp-diamond-2-7-submissions"))||[];const diamond28=JSON.parse(localStorage.getItem("cp-diamond-2-8-submissions"))||[];const diamond29=JSON.parse(localStorage.getItem("cp-diamond-2-9-submissions"))||[];const diamond210=JSON.parse(localStorage.getItem("cp-diamond-2-10-submissions"))||[];const diamond211=JSON.parse(localStorage.getItem("cp-diamond-2-11-submissions"))||[];const diamond212=JSON.parse(localStorage.getItem("cp-diamond-2-12-submissions"))||[];const diamond213=JSON.parse(localStorage.getItem("cp-diamond-2-13-submissions"))||[];const diamond214=JSON.parse(localStorage.getItem("cp-diamond-2-14-submissions"))||[];setSubmissions(current=>[...gold13,...gold14,...gold15,...gold16,...gold17,...gold18,...gold19,...gold110,...gold111,...gold112,...gold113,...gold114,...gold115,...gold116,...gold117,...gold118,...gold119,...gold120,...gold21,...gold22,...gold23,...gold24,...gold25,...platinum12,...platinum13,...platinum14,...platinum15,...platinum16,...platinum17,...platinum18,...platinum19,...platinum110,...platinum221,...platinum222,...platinum223,...platinum224,...platinum225,...platinum226,...platinum227,...platinum228,...platinum229,...platinum2210,...platinum2211,...platinum2212,...platinum2213,...platinum2214,...platinum2215,...diamond11,...diamond12,...diamond13,...diamond14,...diamond15,...diamond21,...diamond22,...diamond23,...diamond24,...diamond25,...diamond26,...diamond27,...diamond28,...diamond29,...diamond210,...diamond211,...diamond212,...diamond213,...diamond214,...current].sort((a,b)=>new Date(b.submittedAt)-new Date(a.submittedAt)))}catch{}});
  },[]);
  useEffect(()=>{
    requestAnimationFrame(()=>{try{const diamond215=JSON.parse(localStorage.getItem("cp-diamond-2-15-submissions"))||[];setSubmissions(current=>[...diamond215,...current].sort((a,b)=>new Date(b.submittedAt)-new Date(a.submittedAt)))}catch{}});
  },[]);
