...
const publishedSilverHustleRoutes = ["/course/silver/starting-a-side-hustle", "/course/silver/gig-work-in-canada", "/course/silver/freelancing", "/course/silver/virtual-assistance", "/course/silver/cleaning-businesses", "/course/silver/property-maintenance", "/course/silver/snow-removal"];

function SilverCatalog() {
  return <div className="tier-content"><p className="tier-includes">Includes all Starter Courses</p>{silverCourses.map((course,courseIndex)=><details className="catalog-course" open={courseIndex<3} key={course.title}><summary><span>{`COURSE ${courseIndex+1}`}</span><div><strong>{course.title}</strong><small>{course.modules.length} modules · {courseIndex===0?"10 published":courseIndex===1?"5 published":courseIndex===2?"7 published":`${course.modules.length} planned`}</small></div><i aria-hidden="true">+</i></summary><ol className="module-list">{course.modules.map((title,moduleIndex)=>{const published=(courseIndex===0&&moduleIndex<10)||(courseIndex===1&&moduleIndex<5)||(courseIndex===2&&moduleIndex<7);return <li className={published?"published":""} key={title}><span>{`${courseIndex+1}.${moduleIndex+1}`}</span><div><strong>{title}</strong><small>{published?"Published":"Planned"}</small></div>{published&&<a href={(courseIndex===0?publishedSilverRoutes:courseIndex===1?publishedSilverMoneyRoutes:publishedSilverHustleRoutes)[moduleIndex]} target="_blank" rel="noreferrer" aria-label={`Open ${title} learner view`}>Open ↗</a>}</li>})}</ol></details>)}</div>;
}
...
export function AdminDashboard() {
  ...
  useEffect(()=>{
    requestAnimationFrame(()=>{try{const course11=JSON.parse(localStorage.getItem("cp-course-1-submissions"))||[];const course12=JSON.parse(localStorage.getItem("cp-course-1-2-submissions"))||[];const course13=JSON.parse(localStorage.getItem("cp-course-1-3-submissions"))||[];const course14=JSON.parse(localStorage.getItem("cp-course-1-4-submissions"))||[];const course15=JSON.parse(localStorage.getItem("cp-course-1-5-submissions"))||[];const course16=JSON.parse(localStorage.getItem("cp-course-1-6-submissions"))||[];const course17=JSON.parse(localStorage.getItem("cp-course-1-7-submissions"))||[];const course18=JSON.parse(localStorage.getItem("cp-course-1-8-submissions"))||[];const course19=JSON.parse(localStorage.getItem("cp-course-1-9-submissions"))||[];const course110=JSON.parse(localStorage.getItem("cp-course-1-10-submissions"))||[];const course21=JSON.parse(localStorage.getItem("cp-course-2-1-submissions"))||[];const course22=JSON.parse(localStorage.getItem("cp-course-2-2-submissions"))||[];const course23=JSON.parse(localStorage.getItem("cp-course-2-3-submissions"))||[];const course24=JSON.parse(localStorage.getItem("cp-course-2-4-submissions"))||[];const course25=JSON.parse(localStorage.getItem("cp-course-2-5-submissions"))||[];const course26=JSON.parse(localStorage.getItem("cp-course-2-6-submissions"))||[];const course27=JSON.parse(localStorage.getItem("cp-course-2-7-submissions"))||[];const course28=JSON.parse(localStorage.getItem("cp-course-2-8-submissions"))||[];const course29=JSON.parse(localStorage.getItem("cp-course-2-9-submissions"))||[];const course210=JSON.parse(localStorage.getItem("cp-course-2-10-submissions"))||[];const course211=JSON.parse(localStorage.getItem("cp-course-2-11-submissions"))||[];const course213=JSON.parse(localStorage.getItem("cp-course-2-13-submissions"))||[];const course214=JSON.parse(localStorage.getItem("cp-course-2-14-submissions"))||[];const course215=JSON.parse(localStorage.getItem("cp-course-2-15-submissions"))||[];const silver11=JSON.parse(localStorage.getItem("cp-silver-1-1-submissions"))||[];const silver12=JSON.parse(localStorage.getItem("cp-silver-1-2-submissions"))||[];const silver13=JSON.parse(localStorage.getItem("cp-silver-1-3-submissions"))||[];const silver14=JSON.parse(localStorage.getItem("cp-silver-1-4-submissions"))||[];const silver15=JSON.parse(localStorage.getItem("cp-silver-1-5-submissions"))||[];const silver16=JSON.parse(localStorage.getItem("cp-silver-1-6-submissions"))||[];const silver17=JSON.parse(localStorage.getItem("cp-silver-1-7-submissions"))||[];const silver18=JSON.parse(localStorage.getItem("cp-silver-1-8-submissions"))||[];const silver19=JSON.parse(localStorage.getItem("cp-silver-1-9-submissions"))||[];const silver110=JSON.parse(localStorage.getItem("cp-silver-1-10-submissions"))||[];const silver21=JSON.parse(localStorage.getItem("cp-silver-2-1-submissions"))||[];const silver22=JSON.parse(localStorage.getItem("cp-silver-2-2-submissions"))||[];const silver23=JSON.parse(localStorage.getItem("cp-silver-2-3-submissions"))||[];const silver24=JSON.parse(localStorage.getItem("cp-silver-2-4-submissions"))||[];const silver25=JSON.parse(localStorage.getItem("cp-silver-2-5-submissions"))||[];const silver31=JSON.parse(localStorage.getItem("cp-silver-3-1-submissions"))||[];const silver32=JSON.parse(localStorage.getItem("cp-silver-3-2-submissions"))||[];const silver33=JSON.parse(localStorage.getItem("cp-silver-3-3-submissions"))||[];const silver34=JSON.parse(localStorage.getItem("cp-silver-3-4-submissions"))||[];const silver35=JSON.parse(localStorage.getItem("cp-silver-3-5-submissions"))||[];const silver36=JSON.parse(localStorage.getItem("cp-silver-3-6-submissions"))||[];const silver37=JSON.parse(localStorage.getItem("cp-silver-3-7-submissions"))||[];setSubmissions([...course11,...course12,...course13,...course14,...course15,...course16,...course17,...course18,...course19,...course110,...course21,...course22,...course23,...course24,...course25,...course26,...course27,...course28,...course29,...course210,...course211,...course213,...course214,...course215,...silver11,...silver12,...silver13,...silver14,...silver15,...silver16,...silver17,...silver18,...silver19,...silver110,...silver21,...silver22,...silver23,...silver24,...silver25,...silver31,...silver32,...silver33,...silver34,...silver35,...silver36,...silver37].sort((a,b)=>new Date(b.submittedAt)-new Date(a.submittedAt)))}catch{}});
  },[]);
