    ...
    <main className="reader-main">
      ...
      <div className="reader-body">
        ...
        <section className="reader-section" id="action">
          ...
          <details className="thinking-guide"><summary>Check Your Thinking <ChevronDown /></summary><div><p><b>11.</b> Use bureau, report date, lender name and a safe partial identifier—no unnecessary sensitive information.</p><p><b>12.</b> Name one precise fact, such as “the May payment is shown 60 days late.”</p><p><b>13.</b> State the replacement fact just as precisely.</p><p><b>14.</b> Every document should answer “what does this prove?” Relevant evidence beats volume.</p><p><b>15.</b> Ask for one correction or investigation tied to the disputed fact.</p><p><b>16.</b> Keep the submission date, organization, method, reference number and copies.</p><p><b>17.</b> Re-check the exact disputed field on the updated report.</p></div></details>
        </section>
