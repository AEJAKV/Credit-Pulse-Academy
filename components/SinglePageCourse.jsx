        ...
        <div className="reader-body">
          ...
          <section className="reader-section" id="myths">
            ...
            <div className="story-card">
              ...
              <div className="story-content"><p className="reader-kicker">WHY A SCORE CAN MOVE EVEN WHEN YOU PAY ON TIME</p><h3>Meet Maya</h3><p>Maya is an early-childhood educator in Winnipeg. She has never missed a credit-card payment and hopes to replace her aging car in the spring without financing it until the next ice age.</p><p>Then January does what January does. Her car needs a $3,400 repair, and Winnipeg winter is not accepting “I’m protecting my credit utilization” as a transportation plan. Maya puts it on her $5,000-limit card. Her balance reaches $3,700—or 74% of the limit.</p><p>She pays on time, but the high balance is reported before her next paycheque. Her score drops just before a financing appointment. Maya pauses the application, checks both Canadian credit reports, confirms her statement date and pays down the card over the next two paydays.</p><p>As lower balances are reported, her utilization falls and her score may adjust. Maya was never irresponsible; the credit snapshot simply caught her car wearing a very expensive winter coat.</p><p><strong>The lesson:</strong> paying on time matters, but so does the balance reported. Before an important application, check your reports, watch utilization and allow updates time to appear.</p></div>
            </div>
          </section>
